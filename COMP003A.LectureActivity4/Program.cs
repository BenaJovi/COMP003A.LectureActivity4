...
namespace COMP003A.LectureActivity4
{
        internal class Program
   {
        static void Main(string[] args)
        {
            ...
            // enumerates the elements of a collection and executes its body for each 
            ...
            /* 
                * The do statement executes a statement or a block of statements while a 
                    specified
                * Boolean expression evaluates to true. Because that expression is 
                    evaluated after
            ...
            */
             ...
             int counter2 = 0; // initial counter2 value
                ...
                * Boolean expression evaluates to true. Because that expression is 
                evaluated before 
                * each execution of the loop, a while loop executes zero or more times. The 
                while 
